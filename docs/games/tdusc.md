...
This game knows what it wants to be — it just isn’t _always_ that. But when it clicks? It’s _cruising in heavy weather with mood lighting on and synthwave playing_. And somehow, that’s exactly what I wanted.
